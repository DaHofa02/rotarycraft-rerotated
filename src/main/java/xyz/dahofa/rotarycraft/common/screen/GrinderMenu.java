...
import xyz.dahofa.rotarycraft.common.registry.RCMenuTypes;
...
public class GrinderMenu extends AbstractContainerMenu {
    ...
    public GrinderMenu(int containerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(RCMenuTypes.GRINDER_MENU.get(), containerId);
        ...
        this.addSlot(new SlotItemHandler(this.blockEntity.itemHandler, 0, 76, 35));
        this.addSlot(new SlotItemHandler(this.blockEntity.itemHandler, 1, 136, 35));
        this.addSlot(new SlotItemHandler(this.blockEntity.itemHandler, 2, 35, 60));
